...
$opt_name = 'opt_name';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	...
	array(
		...
		'fields'=> array(
			...
			array(
				'id'    => 'main_description_1',
				'type'  => 'text',
				'title' => 'Описание второго слайда',
				'desc'  => '',
			),
		),
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Блок "Официальный партнер"', 'your-textdomain-here' ),
		'id'    => 'partner',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'Блок "Официальный партнер"' ),
		'fields'=> array(
			array(
				'id'       => 'partner_image_1',
				'type'     => 'media', 
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Блок "О компании"', 'your-textdomain-here' ),
		'id'    => 'about',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'Блок "О компании"' ),
		'fields'=> array(
			array(
				'id'    => 'about_number_1',
				'type'  => 'text',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Блок "Наши клиенты"', 'your-textdomain-here' ),
		'id'    => 'clients',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'Блок "Наши клиенты"' ),
		'fields'=> array(
			array(
				'id'       => 'clients_1',
				'type'     => 'media', 
	...
	array(
		...
		'fields'=> array(
			array(
				...
				'desc'  => '',
				'placeholder' => '8 800 234 34 75',
			),
			array(
				'id'    => 'phone_href',
				'type'  => 'text',
				'title' => 'Номер телефона для ссылки',
				'desc'  => 'Без пробелов, дефисов, скобок',
				'placeholder' => '88002343475',
			),
			array(
				'id'    => 'address',
				'type'  => 'text',
